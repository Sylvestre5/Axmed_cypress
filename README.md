# Axmed B2B Procurement Ecosystem - Automated Test Engineering Prototype
...
The prototype showcases a mock frontend of a cross-border healthcare procurement hub (e.g., Regional Hub Manager) to simulate and test three core product pillars:
